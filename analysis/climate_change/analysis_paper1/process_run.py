...
def split_exp(ds, exp_save_name,list_names = ["age","precip_age","dynamics","mixed_layer","atmosphere","rrtm_rad","two_stream"]):
    diag_groups = {
        ...
        "age_precip": ['sphum','precip_age','sphum_age_1','sphum_age_2','sphum_age_3','sphum_age_4','sphum','precipitation','dt_sink','dt_q','dt_tracer_diff','dt_tracer',
...
def process_run(exp_folder_name,exp_save_name,start,end,file_name="atmos_monthly.nc",
                list_names_to_do = ["age","age_precip","dynamics","mixed_layer","atmosphere","rrtm_rad","two_stream"]):
...
if __name__ == "__main__":
    ...
    process_run(exp_folder_name,f"{exp_folder_name}_5yrs_E",361,420,file_name="atmos_monthly.nc")