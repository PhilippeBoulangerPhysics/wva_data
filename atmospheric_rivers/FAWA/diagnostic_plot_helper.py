...
def open_experiment(exp_folder_name, start_file, end_file, file_name,base_dir = os.environ['GFDL_DATA']):
    ...
    ds = xar.open_mfdataset(files,  combine='nested', concat_dim='time',decode_times=False,parallel=True)  
    return ds
